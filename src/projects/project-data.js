...
{
  id: 1,  
  name: "So Much Crime So Little Time", 
  image: "public/images/Screenshot 2026-07-28 at 12-50-16 So Much Crime So Little Time.png", 
  skills: ["HTML", "CSS"], 
  AI: false, 
  description: "Designed and created a HTML and CSS based website for a podcast with API calls to the podcast RSS feed to the update the most recent updates and episodes library. Worked with Hosts to create and to push updates of website as needs changed.", 
  link: "https://somuchcrimesolittletime.com/", 
  github: "#" 
},
{
    id: 2, 
